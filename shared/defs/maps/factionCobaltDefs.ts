...
const mapDef: PartialMapDef = {
    ...
    gameMode: {
        ...
        factions: 2,
        perkMode: true,
        perkModeRoles: ["scout", "sniper", "healer", "demo", "assault", "tank", "leader", "captain", "bugler", "recon", "marksman", "grenadier", "medic"],
    },
...
export const FactionCobalt = util.mergeDeep({}, Main, mapDef) as MapDef;
