...
export const BaseDefs: Record<string, GunDef> = {
    ...
    m250: {
        ...
        shotSpread: 1.4,
        bulletCount: 1,
        bulletType: "bullet_m250",
        headshotMult: 2,
        speed: { equip: 0, attack: -3 },
        lootImg: {
            sprite: "loot-weapon-m250.img",
            tint: 0xff00,
            border: "loot-circle-outer-01.img",
            borderTint: 0,
            scale: 0.3,
