...
const SkinDefs: Record<string, MeleeDef> = {
    ...
    naginata_orchid: defineMeleeSkin("naginata", {
        name: "Naginata Orchid",
        lootImg: { sprite: "loot-melee-naginata-orchid.img" },
        worldImg: { sprite: "loot-melee-naginata-orchid.img" },
    }),
