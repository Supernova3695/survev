...
function createRefrigerator(overrides: DeepPartial<ObstacleDef>): ObstacleDef {
    const baseDef: ObstacleDef = {
        type: "obstacle",
        scale: { createMin: 1, createMax: 1, destroy: 0.75 },
...
function createSafe(overrides: DeepPartial<ObstacleDef>): ObstacleDef {
    const baseDef: ObstacleDef = {
        type: "obstacle",
...
function createSink(overrides: DeepPartial<ObstacleDef>): ObstacleDef {
    const baseDef: ObstacleDef = {
        type: "obstacle",
        scale: { createMin: 1, createMax: 1, destroy: 0.8 },
...
function createWheel(overrides: DeepPartial<ObstacleDef>): ObstacleDef {
    const baseDef: ObstacleDef = {
        type: "obstacle",
        scale: { createMin: 1, createMax: 1, destroy: 1 },
...
export const FurnitureDefs: Record<string, ObstacleDef> = {
