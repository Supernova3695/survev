...
function createRiverChest(overrides: DeepPartial<ObstacleDef>): ObstacleDef {
    const baseDef = createChest({
...
function createAirdrop(overrides: DeepPartial<ObstacleDef>): ObstacleDef {
    ...
    return util.mergeDeep(createCrate(baseDef), overrides);
}
...
export const CrateDefs: Record<string, ObstacleDef> = {
    ...
    case_10: createCase({
        health: 140,
        img: {
            sprite: "map-case-grenade-01.img",
            residue: "map-case-hatchet-res-01.img",
        },
        loot: [
            autoLoot("frag", 2),
