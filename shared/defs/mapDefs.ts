...
import { FactionWoods } from "./maps/factionWoodsDefs.ts";
import { FactionWoodsSpring } from "./maps/factionWoodsSpringDefs.ts";
...
const _MapDefs = {
    ...
    faction_woods: FactionWoods,
    faction_woods_spring: FactionWoodsSpring,
    halloween: Halloween,
    potato: Potato,
